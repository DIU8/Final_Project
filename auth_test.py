...
def test_registration(browser):
    ...
    inputs[0].send_keys('Игорь')
    inputs[1].send_keys('Игорь')
    inputs[2].send_keys('Москва')
    inputs[3].send_keys('Vsemprivet8888@yandex.ru')
    inputs[4].send_keys('Privet8')
    inputs[5].send_keys('Privet8')
...
def test_auth_incorrect_mail(browser):
    inputs = browser.find_elements(By.XPATH, '//input[contains(@class, "rt-input__input")]')
    inputs[0].send_keys('test@mail.ru')
